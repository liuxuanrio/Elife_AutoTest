...
@allure.feature("Available")
class Test_Available:
    @pytest.mark.parametrize('caseProject,caseModule,caseTitle,caseDescription,casePoint', OpenFile().testCaseAll("Available"))
    def test_Available_action(self, caseProject, caseModule, caseTitle, caseDescription, casePoint):
        # 用例名称
        allure.dynamic.title(caseTitle)
...
@allure.feature("Booked")
class Test_Booked:
    @pytest.mark.parametrize('caseProject,caseModule,caseTitle,caseDescription,casePoint', OpenFile().testCaseAll("Booked"))
    def test_Booked_action(self, caseProject, caseModule, caseTitle, caseDescription, casePoint):
        # 用例名称
        allure.dynamic.title(caseTitle)
